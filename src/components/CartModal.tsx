...
const CartModal:React.FC<Props> = ({isCartModalOpen}) => {
    return (
        <section className={`cart-modal w-screen px-20 ${isCartModalOpen? "relative" : "hidden"}`}>
            <div className="cart-box h-40 w-72 bg-white shadow-xl  rounded-xl px-5 py-3 mb-1 mt-1 absolute right-10">
